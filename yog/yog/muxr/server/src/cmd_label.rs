...
mod tests {
    ...
    #[case::cmd_with_args("cargo test", "/work/project", Some("cargo test"))]
    #[case::custom_cmd_with_args("gkg server", "/work/project", Some("gkg server"))]
    #[case::relative_cmd("./script.sh", "/work/project", Some("./script.sh"))]
    #[case::relative_cmd_with_args("../bin/gkg server", "/work/project", Some("../bin/gkg server"))]
    #[case::absolute_cmd_with_args("/usr/bin/cargo test", "/work/project", Some("/usr/bin/cargo test"))]
    #[case::home_cmd_with_args("~/bin/tool run", "/work/project", Some("~/bin/tool run"))]
