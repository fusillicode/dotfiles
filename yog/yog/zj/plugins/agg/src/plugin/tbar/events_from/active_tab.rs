...
pub fn derive(state: &TbarState, active_tab_id: usize, landing_focus: Option<FocusedPane>) -> Vec<Event> {
...
mod tests {
    ...
    use crate::plugin::tbar::events_from::active_tab::*;
    ...
    fn test_active_tab_pipe_reconciles_real_landing_focus_after_stale_tab_update_focus() {
        ...
        let tab_update_events = crate::plugin::tbar::events_from::tab_update::derive(
            &state,
            &mut tabs,
            Some(FocusedPane {
                id: 43,
