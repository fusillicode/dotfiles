...
pub fn derive(state: &TabBarState, pane_id: u32, cwd: PathBuf) -> Vec<Event> {
...
mod tests {
    ...
    use crate::plugin::tab_bar::Event;
    use crate::plugin::tab_bar::TabBarState;
    use crate::plugin::tab_bar::events_from::cwd::*;

    #[test]
    fn test_derive_caches_non_display_pane_cwd() {
        assert_eq!(
            derive(&TabBarState::default(), 42, PathBuf::from("/tmp/project")),
