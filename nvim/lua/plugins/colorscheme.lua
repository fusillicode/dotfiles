    ...
    require('nightfox').setup({
      ...
      groups = {
        all = {
          ...
          DiagnosticFloatingError = { fg = 'red', bg = 'black', },
          DiagnosticFloatingHint  = { fg = 'aqua', bg = 'black', },
          DiagnosticFloatingInfo  = { fg = 'white', bg = 'black', },
          DiagnosticFloatingOk    = { fg = 'limegreen', bg = 'black', },
          DiagnosticFloatingWarn  = { fg = 'orange', bg = 'black', },
