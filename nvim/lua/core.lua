...
vim.api.nvim_set_hl(0, 'DiagnosticHint', { fg = 'aqua', })
vim.api.nvim_set_hl(0, 'DiagnosticInfo', { fg = 'white', })
...
vim.api.nvim_set_hl(0, 'DiagnosticFloatingHint', { fg = 'aqua', })
...
vim.api.nvim_set_hl(0, 'DiagnosticUnderlineError', { sp = 'red', })
vim.api.nvim_set_hl(0, 'DiagnosticUnderlineHint', { sp = 'aqua', })
vim.api.nvim_set_hl(0, 'DiagnosticUnderlineInfo', { sp = 'white', })
vim.api.nvim_set_hl(0, 'DiagnosticUnderlineOk', { sp = 'limegreen', })
vim.api.nvim_set_hl(0, 'DiagnosticUnderlineWarn', { sp = 'orange', })
...
vim.api.nvim_set_hl(0, 'LspInlayHint', { fg = 'grey', bg = 'none', })
vim.api.nvim_set_hl(0, 'MatchParen', { fg = 'black', bg = 'orange', })
