...
function M.telescope(telescope, telescope_builtin, defaults)
  ...
  keymap_set('n', '<leader>gc', with_defaults('git_commits', { prompt_prefix = 'Git Commits*: ', }))
  keymap_set('n', '<leader>gcb', with_defaults('git_bcommits', { prompt_prefix = 'Git Commits:', bufnr = 0, }))
  keymap_set('n', '<leader>gb', with_defaults('git_branches', { prompt_prefix = 'Git Branches: ', }))
