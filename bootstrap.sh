...
apm install language-apache language-babel language-docker language-elixir language-elm language-haproxy language-haskell language-nginx language-rspec language-rust language-scala language-slim atom-alignment change-case custom-title highlight-column open-git-modified-files pinned-tabs rails-open-rspec rspec
