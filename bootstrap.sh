...
apm install atom-alignment atom-beautify atom-material-syntax-dark change-case custom-title git-plus highlight-column language-babel language-docker language-elixir language-elm language-haskell language-rspec language-rust language-scala language-slim lines open-git-modified-files pinned-tabs rails-transporter ruby-test trailing-spaces
