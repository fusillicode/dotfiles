...
apm install language-babel language-docker language-elixir language-elm language-haskell language-rspec language-rust language-scala language-slim atom-alignment change-case custom-title git-plus highlight-column lines open-git-modified-files pinned-tabs rails-transporter ruby-test trailing-spaces
