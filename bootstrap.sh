...
# TODO Install gems
# . ~/.rvm/scripts/rvm
# gem install artoo brakeman bundle-audit bundler cane compass consistency_fail html2slim license_finder rails rails-audit rails_best_practices rake rubocop rubycritic wordmove
