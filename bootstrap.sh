...
# Install Ruby gems
gem install --no-rdoc --no-ri brakeman bundler-audit bundler cane compass consistency_fail fasterer html2slim license_finder rails rails-audit rails_best_practices rake reek ruby-lint rubocop rubycritic wordmove
...
ext install Align All-Autocomplete Ruby change-case cucumberautocomplete elm erlang gitlens haml json-tools language-haskell language-purescript referenceshelper rspec-snippets ruby-snippet sass-indented selectline-statusbar slim smarty sort-lines trailing-spaces vscode-docker vscode-elixir vscode-eslint vscode-fileutils xml
